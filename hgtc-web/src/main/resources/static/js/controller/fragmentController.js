 //控制层 
app.controller('fragmentController' ,function($scope,$controller ,$location,fragmentService){
    //读取列表数据绑定到表单中  
	$scope.selectByMemberId=function(){
        fragmentService.selectByMemberId().success(
			function(response){
